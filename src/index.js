...
import AllServies from "./Services/AllServices";
import Contact from "./Contact/Contact";
import AllCheck from "./CheckIn/AllCheck";
import Login from "./CheckIn/Login";
import ThankCreate from "./CheckIn/ThankCreate";
...
import ThankYou from "./Apply/ThankYou";
...
createRoot(document.getElementById("root")).render(
  ...
  <div id="floatingText" class="floating-text">
 
  <a id="chat" className="chat" href="https://wa.me/01284567001" target="_blank">
			<span> Chat With Us  </span> <i
				class="elementor-icons-manager__tab__item__icon fab fa-whatsapp"></i>
		</a>
</div>
